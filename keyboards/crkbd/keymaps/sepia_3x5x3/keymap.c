...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_split_3x6_3(
        ...
        //|-----------+-----------+-----------+-----------+-----------+-----------|                    |-----------+-----------+-----------+-----------+-----------+-----------|
              KC_NO,  LSFT_T(KC_A),   KC_S,       KC_D,       KC_F,       KC_G,                            KC_H,      KC_J,        KC_K,       KC_L,  RSFT_T(KC_SCLN), KC_NO,
        //|-----------+-----------+-----------+-----------+-----------+-----------|                    |-----------+-----------+-----------+-----------+-----------+-----------|
              KC_NO,  LCTL_T(KC_Z),LGUI_T(KC_X),LALT_T(KC_C), KC_V,       KC_B,                            KC_N,      KC_M,LALT_T(KC_COMM),RALT_T(KC_DOT),RCTL_T(KC_SLSH),KC_NO,
        //|-----------+-----------+-----------+-----------+-----------+-----------|                    |-----------+-----------+-----------+-----------+-----------+-----------|
